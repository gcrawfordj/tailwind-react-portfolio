...
const projects = [
    {
        ...
        description: "Template Project 1",
        image: "/projects/project1_stock.jpg",
    ...
    },
    {
        ...
        image: "/projects/project2_stock.jpg",
        tags: ["React", "TailwindCSS", "Supabase"],
        demoUrl: "#",
        githubUrl: "#",
    },
    {
        ...
        description: "Template Project 3",
        image: "/projects/project3_stock.jpg",
        tags: ["React", "TailwindCSS", "Supabase"],
        demoUrl: "#",
        githubUrl: "#",
    },
    ...
    return <section id="projects" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            ...
            crafted with attention to detail, performance, and user experience in mind.
          </p>
          ...
          <div className="text-center mt-12">
            <a className="cosmic-button w-fit flex items-center mx-auto gap-2" href="https://github.com/gcrawfordj" target="_blank"> 
